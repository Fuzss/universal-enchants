...
public class ModRegistry {
    public static final RegistrySetBuilder REGISTRY_SET = new RegistrySetBuilder().add(Registries.ENCHANTMENT,
            ModRegistriesDatapackProvider::boostrapEnchantments);
